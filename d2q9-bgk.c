			...
			** scratch space grid */
			...
			if (obstacles[idx]) {
				...
				** mirroring, and writing into main grid */
				...
				tmp_cells[idx].speeds[0] = speeds0 * one_minus_omega + w0_den_omega * one_minus_term_sq;
				/* axis speeds: weight w1 */
				tmp_cells[idx].speeds[1] = speeds1 * one_minus_omega + w1_den_omega * (one_minus_term_sq + cu1 * (1.0f + 0.5f * cu1));
				tmp_cells[idx].speeds[2] = speeds2 * one_minus_omega + w1_den_omega * (one_minus_term_sq + cu2 * (1.0f + 0.5f * cu2));
				tmp_cells[idx].speeds[3] = speeds3 * one_minus_omega + w1_den_omega * (one_minus_term_sq + cu3 * (1.0f + 0.5f * cu3));
				tmp_cells[idx].speeds[4] = speeds4 * one_minus_omega + w1_den_omega * (one_minus_term_sq + cu4 * (1.0f + 0.5f * cu4));
				/* diagonal speeds: weight w2 */
				tmp_cells[idx].speeds[5] = speeds5 * one_minus_omega + w2_den_omega * (one_minus_term_sq + cu5 * (1.0f + 0.5f * cu5));
				tmp_cells[idx].speeds[6] = speeds6 * one_minus_omega + w2_den_omega * (one_minus_term_sq + cu6 * (1.0f + 0.5f * cu6));
				tmp_cells[idx].speeds[7] = speeds7 * one_minus_omega + w2_den_omega * (one_minus_term_sq + cu7 * (1.0f + 0.5f * cu7));
				tmp_cells[idx].speeds[8] = speeds8 * one_minus_omega + w2_den_omega * (one_minus_term_sq + cu8 * (1.0f + 0.5f * cu8));
